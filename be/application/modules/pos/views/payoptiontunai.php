                  ...
                  <form id="" action="#" method="" novalidate=""> 
                    <div class="row"> 
                      <div class="col-md-4 col-md-offset-4">
                        ...
                        <br> 
                        <div class="form-group">
                          <input class="form-control" type="text" value="" name="" required="true" placeholder="Jumlah Uang Tunai">
                        </div>
                        <div class="form-group">
                          <input class="form-control" type="email" value="" name="" required="true" placeholder="Alamat Email">
                        </div>
                      </div> 
                    </div>  
                    <br>
                    <div class="row">
                      <div class="col-md-4 col-md-offset-4">
                        <div class="footer">
                          <a href="#" class="btn btn-success btn-fill btn-wd btn-next btn-block" data-toggle="modal" data-target="#bayar">Bayar
                          </a>  
                          <div class="clearfix">
                          </div>
                        </div>
