              ...
              <div class="card card-wizard no-pr-pl" id="wizardCard">
                <form id="wizardForm" method="" action="#" novalidate="novalidate">
                  ...
                  <div class="row">
                    <div class="text-center">
                      <div class="footer">
                        <a href="<?php echo site_url('setting/produk/add') ?>" type="button" class="btn btn-warning btn-wd btn-back disabled" style="display: none;">Sebelumnya
                        </a>
                        <a href="<?php echo site_url('setting/produk/sumary/') ?>" type="button" class="btn btn-warning btn-fill btn-wd btn-next">Berikutnya
                        </a>
