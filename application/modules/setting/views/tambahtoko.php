                          ...
                          <div class="row">
                            <div class="col-md-4 col-sm-4 col-md-offset-4 col-sm-offset-4">
                              <div class="form-group"> 
                                <input class="form-control" type="text" name="namatoko" placeholder="Nama Toko" required="true">
                              </div>
                            </div>
                          </div>
                          <div class="row"> 
                            <div class="col-md-4 col-sm-4 col-md-offset-4 col-sm-offset-4">
                              ...
                              <div class="input-group" style="width:100%;">
                                <input placeholder="Alamat" type="text" class="form-control" value="" required="true">
                  ...
                  <div class="row">
                    <div class="text-center">
                      <div class="footer">
                        ...
                        <a href="<?php echo site_url('setting/toko/edit/') ?>" class="btn btn-warning btn-wd btn-ubah" style="display: none;">Ubah
                        </a>
                        <button type="button" class="btn btn-warning btn-fill btn-wd btn-next">Berikutnya
                        </button>
                        <button type="button" class="btn btn-success btn-fill btn-wd btn-finish" data-toggle="modal" data-target="#sukses" data-dismiss="modal">Buat
                        </button>
                        <div class="clearfix">
                        </div>
                      </div>
  ...
  <div class="modal-dialog" role="document" style="width: 28%;">
    <div class="modal-content">
      ...
      <div class="modal-body p-t-0" style="padding-left: 70px;padding-right:70px;"> 
        ...
        <div class="form-group">
          <!-- aturtoko.html -->
          <a href="<?php echo site_url('setting/toko/') ?>" id="signupSubmit" type="submit" class="btn btn-info btn-fill btn-block">OK
          </a>
        </div>
      </div> 
    </div>
