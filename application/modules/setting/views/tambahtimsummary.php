            ...
            <div class="card">
              ...
              <form id="" action="#" method="" novalidate="">
                <div class="row">
                  ...
                  <div class="text-center tokolist" style="margin-left: -120px;">
                    <img class="" src="<?php echo base_url('assets/img/icon/icon-daftartoko.svg');?>" alt="..." style="width: 25px;">
                    <span class="tokolist-assign">XYZ Mini Store
                    </span> 
                  </div> 
                  <br>
                  <div class="text-center">
                ...
                <div class="row">
                  <div class="text-center">
                    <div class="footer"> 
                      <a href="<?php echo site_url('setting/tim/addassign/') ?>" style="width: 120px" class="btn btn-wd btn-warning">Ubah</a> 
                      <a href="#" style="width: 120px" class="btn btn-success btn-fill btn-wd" data-toggle="modal" data-target="#sukses" data-dismiss="modal">Buat</a> 
                      <div class="clearfix">
                      </div>
                    </div>
                  </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer text-center"> 
        <button type="button" class="btn btn-info btn-fill" data-dismiss="modal">OK
        </button>
      </div> 
    </div>
  </div>
